...
for i = 1, 200 do
    BUi:CreateFont("BCORE.config." .. i, "Montserrat", i, 500)
    BUi:CreateFont("BCORE.configs." .. i, "Montserrat", i, 600)
    BUi:CreateFont("BCORE.configb." .. i, "Montserrat", i, 1024)
end
...
classes.AvatarMask = function(pnl, mask)
	pnl.Avatar = vgui.Create("AvatarMaterial", pnl)
	...
	pnl.SetPlayer = function(s, ply, size) s.Avatar:SetPlayer(ply) end
	pnl.SetSteamID = function(s, id, size) s.Avatar:SetSteamID(id) end
	pnl.SetSteamID64 = function(s, id, size) s.Avatar:SetSteamID64(id) end
end
