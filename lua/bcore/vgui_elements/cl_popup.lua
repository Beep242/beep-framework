...
function PANEL:Init()
    ...
    self.CloseBtn:On("Paint", function(s, w, h)
        ...
        BUi.DrawImgur(0, 0, w, h, "https://Beep242.github.io/bui_images/images/gmod/0cjxwbc.png", Color(255,255,255))
    end)
    self.CloseBtn:Text("")
...
function PANEL:SetMode(mode, data)
    ...
    if mode == "textentry" then
        ...
        entryholder:ClearPaint():Background(Color(44,44,44), 8):On("Paint", function(s, w, h)
            draw.RoundedBox(8, 1, 1, w - 2, h - 2, Color(28,28,28))
            BUi.DrawImgur(h * .15, h * .15, h * .7, h * .7, "https://Beep242.github.io/bui_images/images/gmod/mkp8lur.png", Color(255,255,255))
        end)
